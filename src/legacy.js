...
document.getElementById("infcookies").onclick = function () {
    setInterval(function () {
        Game.computedMouseCps = 9e999;
        Game.cookiesPs = 9e999;
        Game.cpsSucked = 0;
    }, 700);
};
...
document.getElementById("influmps").onclick = function () {
    setInterval(function () {
        Game.gainLumps(9e999);
        Game.lumpCurrentType = 9e999;
        Game.lumpMatureAge = 9e-999;
        Game.lumpOverripeAge = 9e-99;
        Game.lumpRefill = 9e999;
        Game.lumps = 9e999;
        Game.lumpsTotal = 9e999;
        Game.lumpT = 9e999;
    }, 700);
};
...
document.getElementById("ascendbtn").onclick = function () {
    ...
    Game.heavenlyChips = 9e999;
    Game.heavenlyCookies = 9e999;
    Game.heavenlyPower = 9e999;
    Game.prestige = 9e999;
};
...
document.getElementById("geteverything").onclick = function () {
    ...
    Game.heavenlyPower = 9e999;
    Game.prestige = 9e999;
    Game.buildingCps = 9e999;
    Game.computedMouseCps = 9e999;
    Game.baseResearchTime = 9e999;
    Game.SetAllUpgrades(true);
